...
ActiveRecord::Schema.define(:version => 20110121223925) do
  ...
  add_index "pages", ["subject_id"], :name => "index_pages_on_subject_id", :unique => true
  ...
  add_index "sections", ["page_id"], :name => "index_sections_on_page_id", :unique => true
